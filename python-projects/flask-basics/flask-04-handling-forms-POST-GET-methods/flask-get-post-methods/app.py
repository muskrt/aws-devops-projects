...
def convert():
    if request.method == "POST":
        num1 = request.form.get("number3")
        return render_template("convert.html", value = convert_to_binary(num1))
    else:
         return render_template("convert.html", developer_name = "mustafa")
